...
@configclass
class PruebaSceneCfg(InteractiveSceneCfg):
...
@configclass
class PruebaEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the Prueba end-effector pose tracking environment."""

    # Scene settings - how many robots, how far apart?
    scene = PruebaSceneCfg(num_envs=2000, env_spacing=2.5)
    # Basic settings
...
@configclass
class PruebaEnvCfg_PLAY(PruebaEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
